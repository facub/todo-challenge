"""
Django settings for todochallenge project.
...
SECRET_KEY = "django-insecure-u7+o80+vfoplo+&qys-=+nuh7-y5qo48fm=vea_)&v5)dv)s_b"
...
INSTALLED_APPS = [
    ...
    "todolist",  # Add the app to the project
...
ROOT_URLCONF = "todochallenge.urls"
...
WSGI_APPLICATION = "todochallenge.wsgi.application"
